...
3. Enable Google provider in Supabase Auth; add redirect URL `{SITE_URL}/write` (and other routes as needed)
...
After checkout, customers land on:
- Success: `https://www.aquickdraft.com/payment/success`
- Cancelled: `https://www.aquickdraft.com/payment/cancelled`

(These are set automatically by the `create-document-checkout` edge function — you do not enter them in the Stripe Dashboard webhook settings.)
