        ...
        <section className="container mx-auto px-4 py-20 md:py-28 text-center">
          <motion.div {...fadeIn}>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Drafting is free. Sign in and purchase credits ($5 each) to download or share.
            </p>
          ...
          <div className="container mx-auto px-4 text-center">
            <motion.div {...fadeIn}>
              ...
              <div className="inline-block rounded-xl border bg-card p-8 shadow-sm max-w-sm">
                ...
                <p className="text-muted-foreground mt-1">per credit</p>
                <ul className="mt-6 space-y-2 text-sm text-left">
                  <li>✓ 1 credit = PDF download</li>
                  <li>✓ 1 credit = shareable read-only link</li>
