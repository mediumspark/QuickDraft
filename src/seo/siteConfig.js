...
export const siteConfig = {
  ...
  defaultDescription:
    'Agreement templates for game developers, technical folks, and college students. Draft free, preview summaries, pay $5 to download. Templates only — not created by lawyers.',
